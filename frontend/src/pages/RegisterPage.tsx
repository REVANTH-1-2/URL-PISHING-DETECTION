  ...
  return (
    <div className="max-w-md mx-auto my-12 glass-card p-8 rounded-2xl border border-slate-800 space-y-6">
      <div className="text-center space-y-2">
        ...
        <h2 className="text-xl font-extrabold text-white">Create DeepShield Account</h2>
        <p className="text-xs text-slate-400">Register to record scan metrics and access API</p>
      </div>
      ...
      <div className="text-center text-xs text-slate-400">
        Already registered?{' '}
        <button onClick={() => onNavigate('login')} className="text-blue-400 hover:underline font-semibold">
          Sign In
        </button>
      </div>
    </div>
